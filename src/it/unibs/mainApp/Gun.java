...
<<<<<<< Updated upstream
	public final static Gun PISTOL = new Gun("Tac-45", 4, 0.3, 12, 10., 15, new Color(0, 191, 255));				// #00BFFF
=======
	//public final static Gun PISTOL = new Gun("Tac-45", 4, 0.8, 12, 3., 15, new Color(0, 191, 255));				// #00BFFF
	public final static Gun PISTOL = new Gun("Tac-45", 4, 1., 12, 10., 15, new Color(0, 191, 255));				// #00BFFF
>>>>>>> Stashed changes
